...
function interpolateCubic(a, b, c, d, t) {
  return interpolateLinear(
    interpolateQuadratic(a, b, c, t),
    interpolateQuadratic(b, c, d, t),
    t
  );
}
...
function interpolateQuartic(a, b, c, d, e, t) {
  return interpolateLinear(
    interpolateCubic(a, b, c, d, t),
    interpolateCubic(b, c, d, e, t),
    t
  );
}
...
function interpolateQuintic(a, b, c, d, e, f, t) {
  return interpolateLinear(
    interpolateQuartic(a, b, c, d, e, t),
    interpolateQuartic(b, c, d, e, f, t),
    t
  );
}
...
export class Space {
  ...
  static tween(a, b, pct, spin, out) {
    ...
    out.rotation.rad = tweenAngleRadians(
      a.rotation.rad,
      b.rotation.rad,
      pct,
      spin
...
export class MainlineKeyframe extends Keyframe {
  ...
  load(json: any): MainlineKeyframe {
    ...
    json.object_ref.forEach(function (object_ref_json) {
      mainline_keyframe.object_ref_array.push(
        new ObjectRef().load(object_ref_json)
      );
    });
...
export class Timeline extends Element {
  ...
  load(json: any): Timeline {
    ...
    switch (timeline.type) {
      case 'sprite':
        json.key.forEach(function (key_json) {
          timeline.keyframe_array.push(
            new SpriteTimelineKeyframe().load(key_json)
          );
        });
        break;
      case 'bone':
        json.key.forEach(function (key_json) {
          timeline.keyframe_array.push(
            new BoneTimelineKeyframe().load(key_json)
          );
        });
        break;
      case 'box':
        json.key.forEach(function (key_json) {
          timeline.keyframe_array.push(
            new BoxTimelineKeyframe().load(key_json)
          );
        });
        break;
      case 'point':
        json.key.forEach(function (key_json) {
          timeline.keyframe_array.push(
            new PointTimelineKeyframe().load(key_json)
          );
        });
        break;
      case 'sound':
        json.key.forEach(function (key_json) {
          timeline.keyframe_array.push(
            new SoundTimelineKeyframe().load(key_json)
          );
        });
        break;
      case 'entity':
        json.key.forEach(function (key_json) {
          timeline.keyframe_array.push(
            new EntityTimelineKeyframe().load(key_json)
          );
        });
        break;
      case 'variable':
        json.key.forEach(function (key_json) {
          timeline.keyframe_array.push(
            new VariableTimelineKeyframe().load(key_json)
          );
        });
        break;
      default:
...
export class Pose {
  ...
  strike(): void {
    ...
    if (anim) {
      ...
      const mainline_keyframe_index1 = Keyframe.find(
        mainline_keyframe_array,
        time
      );
      const mainline_keyframe_index2 =
        (mainline_keyframe_index1 + 1) % mainline_keyframe_array.length;
      const mainline_keyframe1 =
        mainline_keyframe_array[mainline_keyframe_index1];
      const mainline_keyframe2 =
        mainline_keyframe_array[mainline_keyframe_index2];
      ...
      if (mainline_time1 !== mainline_time2) {
        let mainline_tween =
          (time - mainline_time1) / (mainline_time2 - mainline_time1);
      ...
      data_bone_array.forEach(function (data_bone, bone_index) {
        ...
        const keyframe_index2 =
          (keyframe_index1 + 1) % timeline_keyframe_array.length;
        ...
        const pose_bone = <Bone>(
          (pose_bone_array[bone_index] =
            pose_bone_array[bone_index] || new Bone())
        );
        const bone_timeline_keyframe1 = <BoneTimelineKeyframe>(
          timeline_keyframe1
        );
        const bone_timeline_keyframe2 = <BoneTimelineKeyframe>(
          timeline_keyframe2
        );
        pose_bone
          .copy(bone_timeline_keyframe1.bone)
          .tween(bone_timeline_keyframe2.bone, pct, timeline_keyframe1.spin);
      ...
      data_object_array.forEach(function (data_object, object_index) {
        ...
        switch (timeline.type) {
          case 'sprite':
            const pose_sprite = <SpriteObject>(
              (pose_object_array[object_index] =
                pose_object_array[object_index] || new SpriteObject())
            );
            const sprite_timeline_keyframe1 = <SpriteTimelineKeyframe>(
              timeline_keyframe1
            );
            const sprite_timeline_keyframe2 = <SpriteTimelineKeyframe>(
              timeline_keyframe2
            );
            pose_sprite
              .copy(sprite_timeline_keyframe1.sprite)
              .tween(
                sprite_timeline_keyframe2.sprite,
                pct,
                timeline_keyframe1.spin
              );
          ...
          case 'bone':
            const pose_bone = <Bone>(
              (pose_object_array[object_index] =
                pose_object_array[object_index] || new Bone())
            );
            const bone_timeline_keyframe1 = <BoneTimelineKeyframe>(
              timeline_keyframe1
            );
            ...
            break;
          case 'box':
            const pose_box = <BoxObject>(
              (pose_object_array[object_index] =
                pose_object_array[object_index] || new BoxObject())
            );
            const box_timeline_keyframe1 = <BoxTimelineKeyframe>(
              timeline_keyframe1
            );
            const box_timeline_keyframe2 = <BoxTimelineKeyframe>(
              timeline_keyframe2
            );
            pose_box
              .copy(box_timeline_keyframe1.box)
              .tween(box_timeline_keyframe2.box, pct, timeline_keyframe1.spin);
            ...
            break;
          case 'point':
            const pose_point = <PointObject>(
              (pose_object_array[object_index] =
                pose_object_array[object_index] || new PointObject())
            );
            const point_timeline_keyframe1 = <PointTimelineKeyframe>(
              timeline_keyframe1
            );
            const point_timeline_keyframe2 = <PointTimelineKeyframe>(
              timeline_keyframe2
            );
            pose_point
              .copy(point_timeline_keyframe1.point)
              .tween(
                point_timeline_keyframe2.point,
                pct,
                timeline_keyframe1.spin
              );
            ...
            break;
          case 'sound':
            const pose_sound = <SoundObject>(
              (pose_object_array[object_index] =
                pose_object_array[object_index] || new SoundObject())
            );
            const sound_timeline_keyframe1 = <SoundTimelineKeyframe>(
              timeline_keyframe1
            );
            const sound_timeline_keyframe2 = <SoundTimelineKeyframe>(
              timeline_keyframe2
            );
            pose_sound
              .copy(sound_timeline_keyframe1.sound)
              .tween(
                sound_timeline_keyframe2.sound,
                pct,
                timeline_keyframe1.spin
              );
            ...
            break;
          case 'entity':
            const pose_entity = <EntityObject>(
              (pose_object_array[object_index] =
                pose_object_array[object_index] || new EntityObject())
            );
            const entity_timeline_keyframe1 = <EntityTimelineKeyframe>(
              timeline_keyframe1
            );
            const entity_timeline_keyframe2 = <EntityTimelineKeyframe>(
              timeline_keyframe2
            );
            pose_entity
              .copy(entity_timeline_keyframe1.entity)
              .tween(
                entity_timeline_keyframe2.entity,
                pct,
                timeline_keyframe1.spin
              );
            ...
            break;
          case 'variable':
            const pose_variable = <VariableObject>(
              (pose_object_array[object_index] =
                pose_object_array[object_index] || new VariableObject())
            );
            const variable_timeline_keyframe1 = <VariableTimelineKeyframe>(
              timeline_keyframe1
            );
            const variable_timeline_keyframe2 = <VariableTimelineKeyframe>(
              timeline_keyframe2
            );
            pose_variable.name = timeline.name;
            pose_variable
              .copy(variable_timeline_keyframe1.variable)
              .tween(
                variable_timeline_keyframe2.variable,
                pct,
                timeline_keyframe1.spin
              );
            break;
      ...
      pose.character_map_key_array.forEach(function (character_map_key) {
        ...
        if (character_map) {
          character_map.map_instruction_array.forEach(function (
            map_instruction
          ) {
            pose_object_array.forEach(function (object) {
              switch (object.type) {
                case 'sprite':
                  ...
                  if (
                    sprite_object.folder_index ===
                      map_instruction.folder_index &&
                    sprite_object.file_index === map_instruction.file_index
                  ) {
                    sprite_object.folder_index =
                      map_instruction.target_folder_index;
                    sprite_object.file_index =
                      map_instruction.target_file_index;
                  }
                  break;
                case 'bone':
                case 'box':
        ...
        switch (object.type) {
          case 'sprite':
            ...
            if (bone) {
              Space.combine(
                bone.world_space,
                sprite_object.local_space,
                sprite_object.world_space
              );
            } else {
            ...
            if (file) {
              ...
              const pivot = sprite_object.default_pivot
                ? image_file.pivot
                : sprite_object.pivot;
          ...
          case 'bone': {
            ...
            if (bone) {
              Space.combine(
                bone.world_space,
                bone_object.local_space,
                bone_object.world_space
              );
            } else {
          ...
          case 'point': {
            ...
            if (bone) {
              Space.combine(
                bone.world_space,
                point_object.local_space,
                point_object.world_space
              );
            } else {
      ...
      pose_object_array.forEach(function (object) {
        switch (object.type) {
          case 'entity':
            const entity_object = <EntityObject>object;
            const sub_pose = (entity_object.pose =
              entity_object.pose || new Pose(pose.data));
            const sub_entity_key =
              sub_pose.data.entity_keys[entity_object.entity_index];
            if (sub_entity_key !== sub_pose.getEntity()) {
              sub_pose.setEntity(sub_entity_key);
            }
            const sub_entity = sub_pose.curEntity();
            const sub_anim_key =
              sub_entity.animation_keys[entity_object.animation_index];
      ...
      anim.soundline_array.forEach(function (soundline) {
        function add_sound(sound_keyframe: SoundlineKeyframe): void {
          const folder =
            pose.data.folder_array[sound_keyframe.sound.folder_index];
          const file =
            folder && folder.file_array[sound_keyframe.sound.file_index];
        ...
        if (elapsed_time < 0) {
          if (wrapped_min) {
            ...
            soundline.keyframe_array.forEach(function (
              sound_keyframe: SoundlineKeyframe
            ) {
              if (
                (anim.min_time <= sound_keyframe.time &&
                  sound_keyframe.time < prev_time) ||
                (time <= sound_keyframe.time &&
                  sound_keyframe.time <= anim.max_time)
              ) {
          ...
          if (wrapped_max) {
            ...
            soundline.keyframe_array.forEach(function (
              ...
              if (
                (anim.min_time <= sound_keyframe.time &&
                  sound_keyframe.time <= time) ||
                (prev_time < sound_keyframe.time &&
                  sound_keyframe.time <= anim.max_time)
              ) {
                add_sound(sound_keyframe);
              }
      ...
      anim.eventline_array.forEach(function (eventline) {
        ...
        if (elapsed_time < 0) {
          if (wrapped_min) {
            ...
            // all events between min_time and prev_time, not including prev_time
            // all events between max_time and time
            eventline.keyframe_array.forEach(function (
              event_keyframe: EventlineKeyframe
            ) {
              if (
                (anim.min_time <= event_keyframe.time &&
                  event_keyframe.time < prev_time) ||
                (time <= event_keyframe.time &&
                  event_keyframe.time <= anim.max_time)
              ) {
          ...
          if (wrapped_max) {
            ...
            eventline.keyframe_array.forEach(function (
              ...
              if (
                (anim.min_time <= event_keyframe.time &&
                  event_keyframe.time <= time) ||
                (prev_time < event_keyframe.time &&
                  event_keyframe.time <= anim.max_time)
              ) {
                add_event(event_keyframe);
              }
      ...
      if (anim.meta) {
          ...
          if (elapsed_time < 0) {
            if (wrapped_min) {
              ...
              anim.meta.tagline.keyframe_array.forEach(function (tag_keyframe) {
                if (
                  (anim.min_time <= tag_keyframe.time &&
                    tag_keyframe.time < prev_time) ||
                  (time <= tag_keyframe.time &&
                    tag_keyframe.time <= anim.max_time)
                ) {
            ...
            if (wrapped_max) {
              ...
              anim.meta.tagline.keyframe_array.forEach(function (tag_keyframe) {
                if (
                  (anim.min_time <= tag_keyframe.time &&
                    tag_keyframe.time <= time) ||
                  (prev_time < tag_keyframe.time &&
                    tag_keyframe.time <= anim.max_time)
                ) {
                  add_tag(tag_keyframe);
                }
        ...
        anim.meta.varline_array.forEach(function (varline) {
          ...
          if (keyframe_index1 !== -1) {
            const keyframe_index2 =
              (keyframe_index1 + 1) % keyframe_array.length;
            ...
            const var_def =
              entity.var_defs.var_def_array[varline.var_def_index];
